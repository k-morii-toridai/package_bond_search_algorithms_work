...
def filter_2(df_nnlist):
    ...
    dict_2: dict
    """
    df_nnlist_group_dict = df_nnlist[df_nnlist['central_atom_symbol'] == 'Al'].groupby('central_atom_id').groups
    ...
    for key in df_nnlist_central_atom_ids:
        ...
        bool_list.append(df_nnlist.iloc[df_nnlist_group_dict[key]].sort_values('rel_distance')[bool_sort_dist_list]['neighboring_atom_symbol'].tolist().count('Cl') >= 4)
...
def filter_3(df_nnlist, dict_2):
    ...
    for k, v in dict_2.items():
        bool_list_3.append(set(df_nnlist.iloc[dict_2[k]].sort_values(by='rel_distance')['neighboring_atom_symbol'].tolist()[1:5]) == {'Cl'})
...
def filter_6(df_nnlist, dict_3):
    ...
    for k, v in dict_3.items():
        ...
        bool_list_temp = []
        for H_id in H_ids:
            bool_temp = df_nnlist[df_nnlist['central_atom_id'] == H_id].sort_values('rel_distance')['neighboring_atom_symbol'].tolist()[1] == 'Al'
