...
def filter_2(df_nnlist):
    ...
    dict_2: dict
    """
    df_nnlist_group_dict = df_nnlist[df_nnlist['central_atom_symbol'] == 'S'].groupby('central_atom_id').groups
...
def filter_6(df_nnlist, dict_3):
    ...
    for k, v in dict_3.items():
        ...
        bool_list_temp = []
        for H_id in H_ids:
            bool_temp = df_nnlist[df_nnlist['central_atom_id'] == H_id].sort_values('rel_distance')['neighboring_atom_symbol'].tolist()[1] == 'S'
