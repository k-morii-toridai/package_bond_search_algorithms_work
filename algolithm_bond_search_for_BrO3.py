...
def filter_2(df_nnlist):
    ...
    dict_2: dict
    """
    df_nnlist_group_dict = df_nnlist[df_nnlist['central_atom_symbol'] == 'Br'].groupby('central_atom_id').groups
...
def filter_6(df_nnlist, dict_3):
    ...
    for k, v in dict_3.items():
        ...
        bool_list_temp = []
        for O_id in O_ids:
            bool_temp = df_nnlist[df_nnlist['central_atom_id'] == O_id].sort_values('rel_distance')['neighboring_atom_symbol'].tolist()[1] == 'Br'
